...
const PostItem = ({data}) => {
  ...
  return (
    <View style={{paddingBottom: 10, borderBottomColor: 'gray', borderBottomWidth: 0.2,}}>
      <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 15}}>
        ...
        <Feater name='more-vertical' style={{fontSize: 20}} />
      </View>
      ...
      <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 12, paddingVertical: 15}}>
        ...
        <View style={{flexDirection: 'row', alignItems: 'center'}}>
            ...
            <TouchableOpacity>
                <Feater name='navigation' style={{fontSize: 20}} />
            </TouchableOpacity>
        </View>
        <Feater name='bookmark' style={{fontSize: 20}}/>
      </View>

      <View style={{paddingHorizontal: 15}}>
        <Text>좋아요 {like ? data.likes+1 : data.likes} 개</Text>
        <Text style={{fontWeight: '700', fontSize: 14, paddingVertical: 2}}>게시글 설명글 입니다.</Text>
